...
import EventsList from "../components/EventsList";	import EventsList from "../components/EventsList";
...
export default function UpcomingEvents() {	export default function UpcomingEvents() {
  const [popupOpen, setPopup] = useState(true);
  return (	  return (
    <div className="items-center justify-center">	    <VolunteerPopup open={popupOpen} setOpen={setPopup} />
